...
impl App {
    ...
    pub fn draw_settings(&mut self, frame: &mut Frame) {
        ...
        lines.push(Line::from(Span::styled(" │ [◼]   [_][_][_][_] [_][_][_][_] [_][_][_][_] [_][_][_] [_][_][_][_] │".to_string(), Style::default().fg(self.theme.COLOR_GREY_800))).centered());    
        lines.push(Line::from(Span::styled(" │                                                                     │".to_string(), Style::default().fg(self.theme.COLOR_GREY_800))).centered());    
        ...
        lines.push(Line::from(Span::styled(" │ [__][_][w][_][r][_][_][u][_][o][p][_][_][◼ │ [_][◼][◼] [_][_][_][ | │".to_string(), Style::default().fg(self.theme.COLOR_GREY_800))).centered());    
        lines.push(Line::from(Span::styled(" │ [___][a][s][_][f][g][h][j][_][_][_][_][_][_│           [_][_][_][_| │".to_string(), Style::default().fg(self.theme.COLOR_GREY_800))).centered());    
